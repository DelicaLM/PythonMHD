#MHDBlast_3D_InitializationFile.py
#By Delica Leboe-McGowan, PhD Student, University of Manitoba
#Last Updated: January 1, 2024
#Purpose: Initialization script for 3D magnetohydrodynamic blast (a standard test problem for 3D MHD).
#Additional Information: This problem is the MHD blast test that is defined in [1]. This initialization script
#                        was designed to produce the same gas system as the 3D MHD blast in the 2017 version
...
#                        it will expand into the rest of the simulation volume. The problem is magnetohydrodynamic
#                        because we also have a uniform magnetic field throughout the simulation volume
#References:
...
#Import math for retrieving the value of PI when we set the magnetic field angle in radians
import math as m
...
simPar = {
              ...
              constants.OUTPUT_FOLDER_NAME: "MHDBlast_3D", #name for the outputs folder
              constants.OUTPUT_FILE_NAME: "MHDBlast_3D", #prefix name for the output files
         }
...
visPar = {
            ...
            [
                #Figure 1
                {
                   constants.FIGURE_TITLE: "3D MHD Blast", #title for the figure
